...
def marshal(data, fields, envelope=None, mask=None):
    ...
    >>> from app.flask_restplus import fields    >>> from app.flask_restplus import marshal
    >>> data = { 'a': 100, 'b': 'foo' }
...
class marshal_with(object):
    ...
    >>> from app.flask_restplus import fields    >>> from app.flask_restplus import marshal_with
    >>> mfields = { 'a': fields.Raw }
...
class marshal_with_field(object):
    ...
    >>> from app.flask_restplus import fields    >>> from app.flask_restplus import marshal_with_field
